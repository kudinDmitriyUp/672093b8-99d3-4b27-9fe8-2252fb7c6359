...
export const metadata: Metadata = {
  title: "Кава Дім | Справжня українська кава в Києві",
  description: "Насолоджуйтесь автентичною українською кавою з традиційними рецептами та сучасними техніками приготування. Відвідайте Кава Дім.",
  keywords: "українська кава, кав'ярня Київ, еспресо, капучіно, латте, кавова культура",
  openGraph: {
    title: "Кава Дім | Справжня українська кава",
    description: "Насолоджуйтесь автентичною українською кавою в атмосфері гостинності",
    siteName: "Кава Дім",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764139888520-nx17z6ga.jpg",
      alt: "Справжня українська кава"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Кава Дім | Українська кава культура",
    description: "Відкрийте автентичний смак України в кожній чашці",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764139888520-nx17z6ga.jpg"]
  },
  robots: {
    index: true,
    follow: true
